...
- **v0.4**: simulador local EURUSD/USD (ledger propio, migración `0002`), endpoints `/paper/v04/*`,
  worker opcional con `PAPER_SCHEDULER_ENABLED` (off por defecto). Ver `docs/PAPER_V04.md`.
...
- El worker hace heartbeat; el scheduler paper v0.4 solo corre si `PAPER_SCHEDULER_ENABLED=true`.
- No hay backtesting, descarga YouTube ni aprendizaje automático.
...
- Límites del simulador v0.4 (costos supuestos, muestreo, noticias, OAuth): `docs/PAPER_V04.md`.
